...
test.describe('test oz.by', async function() {
    ...
    // })
    // test ('№5 Remove item from Basket', async ({page})  => {                ///// продумать лучше //////////////////
    //     await mainPage.navigate('https://oz.by/');
    ...
    // })
    // test ('№9 Remove product from favourite', async ({page})  => {              ///// продумать лучше //////////////////
    //     await mainPage.navigate('https://oz.by/');
...
//     test('№18 PromotionOfTheDay', async ({page}) => {       /// неи проходит 2ой экспектед
//         await mainPage.navigate('https://oz.by/')
...
//     test('№19 Find Items From Filter', async ({page}) => {       /// неи проходит 2ой экспектед
//         await mainPage.navigate('https://oz.by/')
