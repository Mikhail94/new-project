...
let a: number = 25;                                 /// пример переменных в TS
let s: string = 'str';                           /// пример переменных в TS
let b: boolean = true;                           /// пример переменных в TS
let n: null = null;                              /// пример переменных в TS
let un: undefined;                               /// пример переменных в TS
let obj: object = {};                            /// пример переменных в TS
let arr: string[] = ['str', '12'];               /// пример переменных в TS
let arr1: number[] = [5, 12];                    /// пример переменных в TS
let any1: any = 'string';                        /// пример переменных в TS. В any  можно ложить любые типы данных 
let any2: any[] = ['string', 12, true];          /// пример переменных в TS. В any  можно ложить любые типы данных 
